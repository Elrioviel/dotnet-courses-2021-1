...
namespace Task1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\t\t\t\t**************************************");
            Console.WriteLine("Object array's length: {0}, array's capacity: {1}", arrayLength, arrayCapacity);
            array2.Remove(0.25);
            Console.WriteLine("Object array's length: {0}, array's capacity: {1}", arrayLength, arrayCapacity);
            Console.WriteLine();
            Console.WriteLine("\t\t\t********************TESTING WITH INT ARRAY********************\n");
            ...
            Console.WriteLine("Array's length: {0}, capacity: {1}\n", arrayOfIntegerLength, arrayOfIntegerCapacity);
            Console.WriteLine("\t\t\t\t**************************************");
            ...
            Console.WriteLine("\nArray's length after adding one element: {0}, capacity: {1}\n", arrayOfIntegerLengthAfterAdd, arrayOfIntegerCapacityAfterAdd);
